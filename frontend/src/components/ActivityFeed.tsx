  ...
  return (
    <section className="tactical-panel panel-cut p-5 md:p-6">
      <div className="flex items-end justify-between gap-4">
        ...
        <p className="mono text-[11px] uppercase tracking-[0.14em] text-stone-500">Indexed Mainnet Flow</p>
      </div>
      ...
      <div className="mt-6 space-y-3">
        ...
        {items.map((item) => (
          <article
            key={item.txId}
            className="metric-card panel-cut relative px-4 py-4 transition hover:border-[rgba(249,115,22,0.34)] hover:bg-[rgba(255,255,255,0.05)]"
          >
            <a
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mono mt-2 text-[11px] tracking-[0.14em] text-stone-500">
